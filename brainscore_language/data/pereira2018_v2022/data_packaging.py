...
from brainio.packaging import upload_to_s3, write_netcdf
from brainscore_core.benchmarks import BenchmarkBase
from brainscore_core.metrics import Score
from brainscore_language import benchmark_registry, load_dataset, load_metric
...
"""
The code in this file is intended to be run only once to initially upload the data, and is kept here
for reference.  
"""
...
def upload_data_assembly(assembly, assembly_identifier, bucket_name):
    ...
    # identifiers
    assembly_store_identifier = "assembly_" + assembly_identifier.replace(".", "_")
